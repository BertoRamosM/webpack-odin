...
export default function contactRender(){
  ...
  '</div>' +
  '<div id="text-content">' +
  '<p id="p1">Restaurant One <br> <br> False street 123, Granville, Normandy, France <br><br> tel. 0816264561 <br> restone@email.com</p>' +
  '<p id="p2">Restaurant Two <br> <br> False street 123, Granville, Normandy, France <br><br> tel. 0854516151551 <br> resttwo@email.com</p>' +
  '<p id="p3">Restaurant Three <br> <br> False street 123, Granville, Normandy, France <br><br> tel. 085151151351 <br> restthree@email.com</p>' +
  '</div>';
  console.log("contact");
  buttonFunctionality();
} 
